...
const WhyChooseUsData = [
    {
        ...
        description: 'Streamlined processes for cleaner scheduling and task management',
        img: Icon_Estimates,
    },
    {
        id: uuidv4(),
        heading: 'Modern Cleaning Tools',
        description: 'Utilizing the latest equipment to ensure the highest quality cleaning services',
        img: Icon_Equipment,
    },
    {
        id: uuidv4(),
        heading: 'Top Quality Service',
        description: 'Dedicated to maintaining the highest standards of cleanliness across all departments',
        img: Icon_Work,
    },
    {
        id: uuidv4(),
        heading: 'Complaint Resolution',
        description: 'Prompt and effective handling of all complaints to ensure satisfaction',
