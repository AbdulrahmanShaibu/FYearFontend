                    ...
                    <div className="row">
                        <div className="col-xl-12">
                            <div className="newsletter-content-wrapper text-center">
                                <h2>Get Updates on Cleaner Management System, <br /> Complaints Handling, Tool Inventory, Departmental Operations, Supervisor Tasks, and More When You Join Our Email List</h2>
                                <form action="#">
