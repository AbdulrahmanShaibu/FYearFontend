...
const Dashboard = () => {
  ...
  const { admin_username, admin_email, admin_phone } = state || {}; // Destructure form data from state
        ...
        <div style={{ fontFamily: 'Arial, sans-serif', textAlign: 'center', margin: '0 auto', maxWidth: '500px', paddingTop: '95px' }}>
          <div style={{ backgroundColor: 'rgb(240, 241, 242)' }}>
            ...
            <div style={
              ...
              <div style={{ color: 'white', fontSize: '14.5px', fontWeight: 'bolder', maxWidth: '500px', textAlign: 'center' }}>Admin Email: {admin_email}</div>
              <div style={{ color: 'white', fontSize: '14.5px', fontWeight: 'bolder', maxWidth: '500px', textAlign: 'center' }}>Admin Name: {admin_username}</div>
              <div style={{ color: 'white', fontSize: '14.5px', fontWeight: 'bolder', maxWidth: '500px', textAlign: 'center' }}>Admin Role: Super Admin</div>
              <div style={{ color: 'white', fontSize: '14.5px', fontWeight: 'bolder', maxWidth: '500px', textAlign: 'center' }}>Admin Contact: {admin_phone}</div>
