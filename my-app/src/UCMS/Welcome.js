                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <Card variant="outlined" style={{ backgroundColor: '#f5f5f5' }}>
                                            <CardContent>
                                                <Typography variant="subtitle2" color="textSecondary">Cleaners</Typography>
                                    ...
                                    <Grid item xs={12} sm={6} md={3}>
                                        <Card variant="outlined" style={{ backgroundColor: '#f5f5f5' }}>
                                            <CardContent>
                                                <Typography variant="subtitle2" color="textSecondary">Total Staffs</Typography>
                                    ...
                                    <Grid item xs={12} sm={6} md={6}>
                                        <Card variant="outlined" style={{ backgroundColor: '#f5f5f5' }}>
                                            <CardContent>
                                                <Typography variant="subtitle2" color="textSecondary">Supervisors</Typography>
                        ...
                        <Card className="card">
                            <Card className="card-body">
                                ...
                                <Paper elevation={5}>
                                    <Table>
                                        <TableHead>
                                            <TableCell style={{ backgroundColor: '#333', color: 'white' }}>Registered Departments</TableCell>
                                            <TableCell style={{ backgroundColor: '#333', color: 'white' }}>Submitted Claims</TableCell>
                                            <TableCell style={{ backgroundColor: '#333', color: 'white' }}>Assigned Tasks</TableCell>
                                            <TableCell style={{ backgroundColor: '#333', color: 'white' }}>All Tools</TableCell>
                                            <TableCell style={{ backgroundColor: '#333', color: 'white' }}>Available Supervisors</TableCell>
                                            <TableCell style={{ backgroundColor: '#333', color: 'white' }}>Available Cleaners</TableCell>
                                        </TableHead>
                                        <TableBody>
                                            <TableCell>{cleanersCount}</TableCell>
                                            <TableCell>{count}</TableCell>
                                            <TableCell>{claimsCount} (reported)</TableCell>
                                            <TableCell>{tasksCount}</TableCell>
                                            <TableCell>{toolsCount}</TableCell>
                                            <TableCell>{supervisorsCount}</TableCell>
                                        </TableBody>
                                    </Table>
                                </Paper>
